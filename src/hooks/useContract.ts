...
import RECORDER_JSON from '@radiusxyz/threesixty-contracts-polygon/artifacts/contracts/Recorder.sol/Recorder.json'
import ROUTER_JSON from '@radiusxyz/threesixty-contracts-polygon/artifacts/contracts/ThreesixtyRouter02.sol/ThreesixtyRouter02.json'
import VAULT_JSON from '@radiusxyz/threesixty-contracts-polygon/artifacts/contracts/Vault.sol/Vault.json'
...
export function useInterfaceMulticall() {
  return useContract<UniswapInterfaceMulticall>(MULTICALL_ADDRESS, MulticallABI, true) as UniswapInterfaceMulticall
}
